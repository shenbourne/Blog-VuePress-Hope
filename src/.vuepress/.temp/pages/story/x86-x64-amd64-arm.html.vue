<template><div><p>x86 是 Intel 在 1978 年推出的一种 32 位指令集。从 386 时代开始的，一直沿用至今，是一种cisc指令集，所有 Intel 早期的 cpu，amd 早期的 cpu 都支持这种指令集，Intel 官方文档里面称为 “IA-32”。</p>
...
<p>总结：3个处理器家族的父子关系</p>
<Mermaid id="mermaid-51" code="eJxLy8kvT85ILCpRCHHi4iwuTUovSizIUKiwMOPi5EzJLEpNLsnMz1NwCgFyEw2jgeKxCrq6dgqJRiC2rplJLLqEcXRibgpYPDUvBclIT0egaqBiT8doMBNDQWJRLlA6OT+vJBpEZOaVZualH9oOglC1AAdkNJg="></Mermaid><p>总结：x86家族的指令集架构分类</p>
<ol>
<li>x86：一般没有别名，在早期的32位 cpu 会出现</li>
<li>x64：别名 x86-64、Intel 64、EM64T等，一般会在 64 位的 Intel 处理器中出现</li>
